class Solution(object):
    def topKFrequent(self, nums, k):
        ...
        for n in nums:
            #keeps track of the occurence of each unique value, if n doesnt exist yet we put a default value of 0
            count[n] = 1 + count.get(n,0)

        #iterate over key-value pairs of count to put into frequency table
        #n = value
        #c = occurence of value 
